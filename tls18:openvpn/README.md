...
```
Server:  # systemctl  start openvpn-server@myvpnserver.service
Client1: # systemctl  start openvpn-client@myvpnclient.service 
Client2: # systemctl  start openvpn-client@myvpnclient.service
```
